...
const collections = require("./api-v2/routes/collection.route");
const genres = require("./api-v2/routes/genre.route");
const movies = require("./api-v2/routes/movie.route");
const users = require("./api-v2/routes/user.route");
const tmdb = require("./api-v2/routes/tmdb.route");
